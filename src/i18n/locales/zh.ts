...
export const zh: TranslationKeys = {
  ...
  settings: {
    ...
    assistants: {
      title: '智能体',
      desc: '创建和管理具有模型和工具选择功能的自定义AI智能体',
      agentsTitle: '智能体',
      agentsDesc: '创建和管理具有特定模型和工具的AI智能体',
      addAssistant: '添加智能体',
      editAssistant: '编辑智能体',
      ...
      // 新智能体功能
      model: '模型',
      modelDesc: '此智能体使用的聊天模型',
      modelPlaceholder: '选择聊天模型',
      tools: '工具',
      toolsDesc: '此智能体可用的MCP工具',
      noToolsAvailable: '无可用MCP工具',
      schema: '模式',
      selectAll: '全选',
      clear: '清空',
      // 导入/导出
      exportAgents: '导出智能体',
      importAgents: '导入智能体',
      exportSuccessFile: '智能体已导出到 {{path}}',
      exportSuccessClipboard: '智能体JSON已复制到剪贴板',
      exportSuccessDownload: '智能体已导出为下载文件',
      exportError: '导出智能体失败。请重试。',
      importError: '导入智能体失败。请重试。',
      importErrorNoFile: '无法读取文件。请复制JSON内容并粘贴。',
      importErrorNoContent: '未找到文件内容',
      importErrorInvalidFormat: 'JSON格式无效。请检查文件。',
      importWarningPartial: '已导入{{count}}个智能体（{{failed}}个验证失败）',
      importErrorNoValidAgents: '没有有效的智能体可导入',
      importSuccess: '成功导入{{count}}个智能体',
      agentsImported: '已导入{{count}}个智能体',
      currentBadge: '当前',
    },
    providers: {
      title: '提供商',
