...
export const it: TranslationKeys = {
  ...
  chat: {
    ...
    agentAnalytics: {
      name: 'Analitiche Agenti',
      desc: 'Visualizza e analizza cronologia e metriche di performance dei richiami degli agenti',
      totalInvocations: 'Richiami totali',
      successful: 'Riusciti',
      failed: 'Falliti',
      failureRate: 'Tasso di fallimento',
      averageTokens: 'Token medio',
      toolUsageRate: 'Tasso di utilizzo strumenti',
      totalTokens: 'Token totali',
      avgExecutionTime: 'Tempo di esecuzione medio',
      filters: 'Filtri',
      filterByAgent: 'ID Agente',
      filterBySurface: 'Superficie',
      recentSessions: 'Sessioni recenti',
      noRecords: 'Nessun record cronologia agenti',
      exportCSV: 'Esporta CSV',
      exportJSON: 'Esporta JSON',
      refresh: 'Aggiorna',
      clear: 'Cancella cronologia',
      clearConfirm: 'Sei sicuro di voler cancellare tutta la cronologia degli agenti?',
    },
  },
