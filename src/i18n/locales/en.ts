...
export const en: TranslationKeys = {
  ...
  settings: {
    ...
    assistants: {
      title: 'Agents',
      desc: 'Create and manage custom AI agents with model and tool selection',
      agentsTitle: 'Agents',
      agentsDesc: 'Create and manage AI agents with specific models and tools',
      ...
      // New agent-specific features
      model: 'Model',
      modelDesc: 'Chat model to use for this agent',
      modelPlaceholder: 'Select a chat model',
      tools: 'Tools',
      toolsDesc: 'MCP tools available to this agent',
      ...
      exportSuccessFile: 'Agents exported to {{path}}',
      exportSuccessClipboard: 'Agents JSON copied to clipboard',
      exportSuccessDownload: 'Agents exported as download',
      exportError: 'Failed to export agents. Please try again.',
      importError: 'Failed to import agents. Please try again.',
      importErrorNoFile:
        'Unable to read file. Please copy the JSON content and paste it.',
      importErrorNoContent: 'No file content found',
      importErrorInvalidFormat: 'Invalid JSON format. Please check your file.',
      importWarningPartial:
        'Imported {{count}} agents ({{failed}} failed validation)',
      importErrorNoValidAgents: 'No valid agents to import',
      importSuccess: 'Successfully imported {{count}} agents',
      agentsImported: '{{count}} agents imported',
    },
    providers: {
      title: 'Providers',
  ...
  chat: {
    ...
    agentAnalytics: {
      ...
      desc: 'View and analyze agent invocation history and performance metrics',
      totalInvocations: 'Total invocations',
      successful: 'Successful',
      failed: 'Failed',
      failureRate: 'Failure rate',
      averageTokens: 'Average tokens',
      toolUsageRate: 'Tool usage rate',
      ...
      noRecords: 'No agent history records',
      exportCSV: 'Export CSV',
      exportJSON: 'Export JSON',
      refresh: 'Refresh',
      clear: 'Clear history',
      clearConfirm: 'Are you sure you want to clear all agent history?',
    },
  },
